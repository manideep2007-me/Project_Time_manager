      ...
      <View style={styles.section}>
        ...
        <Card style={styles.sectionCard}>
          <ProfileItem
            ...
            subtitle={t('profile.update_personal_details')}
            onPress={handleEditProfile}
          />
          <ProfileItem
            icon="🔒"
            title={t('profile.change_password')}
            subtitle={t('profile.update_password')}
            onPress={handleChangePassword}
          />
          <ProfileItem
            icon="📧"
            title={t('profile.email_settings')}
            subtitle={t('profile.manage_email_notifications')}
            onPress={handleSettings}
          />
          <ProfileItem
            icon="📍"
            title={t('profile.my_location')}
            subtitle={t('profile.view_track_location')}
      ...
      <View style={styles.section}>
        ...
        <Card style={styles.sectionCard}>
          <ProfileItem
            ...
            subtitle={t('profile.manage_notification_settings')}
            rightElement={
              <Switch
          ...
          <ProfileItem
            ...
            subtitle={t('profile.switch_dark_theme')}
            rightElement={
              <Switch
          ...
          <View style={styles.languageSwitcherContainer}>
            <ProfileItem
              ...
              subtitle={t('profile.change_app_language')}
